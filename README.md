...
- [![p_win]](#-) [![p_nom]](#-) [![a_all]](#-) [![a_misc]](# "Python") ![GHStars](https://img.shields.io/github/stars/lucafrance/matita?style&logo=github&label) [matita](https://matita.readthedocs.io) - A Python wrapper for the VBA object library. Ideal for migrating VBA code to Python.
